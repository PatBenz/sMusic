...
/**
 * Servlet implementation class SongEdit
 */
@WebServlet("/SongEdit")
public class SongEdit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
			...
			//On transfert tous les songs
			List <Song> songs = SongAction.getSongs();
			request.setAttribute("songs", songs);
			//On transfert tous les song artists
			List <SongArtist> sgarts = SongArtistAction.getSongArtists();
			request.setAttribute("songartists", sgarts);
				 
			this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/song-edit.jsp").forward(request, response);
		}
		else{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
			...
			SongAction.updateSong(request);
			
			//String param = request.getParameter("usrid");
			
		//	Integer userid = Integer.parseInt(request.getParameter("songID"));
