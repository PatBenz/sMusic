...
/**
 * Servlet implementation class DeleteAssociations
 */
@WebServlet("/DeleteAssociations")
public class DeleteAssociations extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(Iuser!=null && Iuser.getRole().getRole().equals("administrateur"))
		{
			...
			this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/delete-associations.jsp").forward(request, response);
		}
		else{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(Iuser!=null && Iuser.getRole().getRole().equals("administrateur"))
		{
			...
			SongArtistAction.deleteSongArtist(request);
			AlbumSongAction.deleteAlbumSong(request);
