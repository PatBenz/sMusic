...
/**
 * Servlet implementation class ArtistEdit
 */
@WebServlet("/ArtistEdit")
public class ArtistEdit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
			...
			Artist art = ArtistAction.getOneArtist(artistid.intValue());
			
			request.setAttribute("artist", art);
			...
			this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/artist-edit.jsp").forward(request, response);
		}
		else{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
			...
			ArtistAction.updateArtist(request);
