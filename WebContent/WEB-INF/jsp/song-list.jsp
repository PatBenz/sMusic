                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<div class="btn-group">
                                        <a href="AddSong"><button class="btn btn-success"><i class="icon-plus icon-white"></i> Add New</button></a>
                                    </div>	
                                        ...
                                        <tbody>
	                                       <c:forEach var="s" items="${songs}" >                                                                   	
	                                           <tr class="odd gradeX">
	                                               ...
	                                               <td>
	                                               		<div class="btn-group">
                                         					<a href="SongEdit?songID=${s.idSong}"><button class="btn btn-primary"><i class="icon-pencil icon-white"></i></button></a>
                                      					</div>
                                      			   </td>
	                                               <td>
	                                               		<div class="btn-group">
