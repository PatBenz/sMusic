                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<div class="btn-group">
                                        <a href="AddGenre"><button class="btn btn-success"><i class="icon-plus icon-white"></i> Add New</button></a>
                                    </div>	
...
<%-- 	                                               <td>${u.year}</td> --%>
	                                               <td>
	                                               		<div class="btn-group">
                                         					<a href="GenreEdit?genreID=${u.idGenre}"><button class="btn btn-primary"><i class="icon-pencil icon-white"></i></button></a>
                                      					</div>
                                      			   </td>
	                                               <td>
	                                               		<div class="btn-group">
                                         					<a href="DeleteGenre?genreID=${u.idGenre}"><button class="btn btn-danger"><i class="icon-trash icon-white"></i></button></a>
                                      					</div>
                                      			   </td>	                                               
	                                           </tr>
	                                       </c:forEach>
