								...
								<div class="block">
									...
									<div class="block-content collapse in">
										<div class="span12">
											...
											<form action="AddEditor" method="post" class="form-horizontal">
												<fieldset>
													<legend>Form Horizontal</legend>
													<div class="control-group">
														<label class="control-label" for="focusedInput">Enter New Editor</label>
														<div class="controls">
...
<!-- 													<div class="control-group"> -->
<!-- 														<label class="control-label" for="focusedInput">Select -->
<!-- 															Type</label> -->
<!-- 														<div class="controls"> -->
