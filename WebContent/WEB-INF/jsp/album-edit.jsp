								...
								<div class="block">
									...
									<div class="block-content collapse in">
										<div class="span12">
											...
											<form action="AlbumEdit" method="post"
													...
													<div class="control-group">
														...
														<div class="controls">
															<input class="input-xlarge focused" type="text"
																...
																<input type="hidden" name="albumID" value="${album.idAlbum}">
														</div>
													</div>
													<div class="control-group">
														<label class="control-label" for="focusedInput">Year</label>
														<div class="controls">
															<input class="input-xlarge focused" type="text" name="year" value="${album.year}" required>
														</div>
													</div>
													<div class="control-group">
...
<!-- 														<div class="controls"> -->
<!-- 															<input class="input-xlarge focused" type="text" -->
<%-- 																name="imageURL" value="${album.imageURL}" required> --%>
<!-- 														</div> -->
<!-- 													</div> -->
													<div class="control-group">
														...
														<div class="controls">
															<input class="input-file uniform_on" id="fileInput"
																type="file" name="imageURL" value="${album.imageURL}">
														</div>
													</div>
