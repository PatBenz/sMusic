                        ...
                        <div class="block">
									...
									<div class="block-content collapse in">
										<div class="span12">
											...
											<form action="DeleteAssociations" method="post" class="form-horizontal">
												<fieldset>
...
<!-- 													</div> -->
										...
										<div class="control-group">
											<label class="control-label" for="multiSelect">Artists</label>
											<div class="controls">
												<select name="artistname" multiple="multiple" id="multiSelect"
													class="chzn-select span4">
<%-- 													<c:forEach var="art" items="${artists}"> --%>
														<c:forEach var="sa" items="${songartists}" > 
												   			<c:if test="${song.idSong == sa.song.idSong}">
																<option value="${sa.artist.idArtist}">${sa.artist.name}</option>
															</c:if>
														</c:forEach>
<%-- 													</c:forEach> --%>
												</select>
												<p class="help-block">Select artists to be removed!</p>
												<input type="hidden" name="songID" value="${song.idSong}">
											</div>
										</div>
...
<!-- 													</div> -->
										<div class="control-group">
											<label class="control-label" for="multiSelect">Albums</label>
											<div class="controls">
												<select name="albumtitle" multiple="multiple" id="multiSelect"
													class="chzn-select span4">
<%-- 													<c:forEach var="alb" items="${albums}"> --%>
														<c:forEach var="as" items="${songalbums}" > 
												   			<c:if test="${song.idSong == as.song.idSong}">
																<option value="${as.album.idAlbum}">${as.album.title}</option>
															</c:if>
														</c:forEach>
<%-- 													</c:forEach> --%>
												</select>
												<p class="help-block">Select albums to be removed!</p>
											</div>
											<div class="controls">
