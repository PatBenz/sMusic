                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                     ...
                                     <form action="GenreEdit" method="post" class="form-horizontal">
                                      <fieldset>
                                        <legend>Form Horizontal</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Enter Label</label>                                    
                                          <div class="controls">
                                            <input class="input-xlarge focused" type="text" name="label" value="${genre.label}" required>
                                             <input type="hidden" name="genreID" value="${genre.idGenre}">
                                          </div>
                                        </div>
