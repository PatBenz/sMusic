                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                     ...
                                     <form action="ArtistEdit" method="post" class="form-horizontal">
                                      <fieldset>
                                        <legend>Form Horizontal</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Name</label>                                    
                                          <div class="controls">
                                            <input class="input-xlarge focused" type="text" name="name" value="${artist.name}" required>
...
<!--                                           <label class="control-label" for="focusedInput">Type</label> -->
<!--                                           <div class="controls"> -->
<%--                                             <input class="input-xlarge focused" type="text" name="label" value="${artist.artisttype.label}" required> --%>
<!--                                           </div> -->
<!--                                         </div> -->
